...
#define EXIFTAGID_ISO_SPEED_RATING		0x8827
#define EXIFTAGID_FLASH		0x9209

#define NATIVE_CAMERA_INTERFACE   0
#define V4L2_CAMERA_INTERFACE     1
...
typedef struct {
    ...
    int32_t  raw_picture_width;
	int32_t  raw_picture_height;
...
typedef enum {
  ...
  CAMERA_PARM_VERTICAL_VIEW_ANGLE,
  CAMERA_PARM_HFR_SIZE,
  CAMERA_PARM_HFR,
  CAMERA_PARM_ZSL_ENABLE,
  CAMERA_PARM_BUFFER_INFO,
  CAMERA_PARM_JPEG_ROTATION,
  CAMERA_PARM_JPEG_MAINIMG_QUALITY,
...
/*typedef enum {
    CAMERA_OPS_LOCAL ,	//no need to query mm-camera
...
typedef enum {
    ...
    CAMERA_OPS_CAPTURE, 
    CAMERA_OPS_FOCUS,
    CAMERA_OPS_GET_PICTURE, 
    CAMERA_OPS_PREPARE_SNAPSHOT,
    CAMERA_OPS_SNAPSHOT,
	CAMERA_OPS_PREVIEW,
    CAMERA_OPS_LIVESHOT,
    CAMERA_OPS_RAW_SNAPSHOT,
    CAMERA_OPS_VIDEO_RECORDING, 
    CAMERA_OPS_REGISTER_BUFFER,
    CAMERA_OPS_UNREGISTER_BUFFER,
    CAMERA_OPS_CAPTURE_AND_ENCODE,
    CAMERA_OPS_RAW_CAPTURE,
